...
const grupo1 = new Cl_Grupo("A", 10, 5);
const grupo2 = new Cl_Grupo("B", 4, 8);
const grupo3 = new Cl_Grupo("C", 2, 6);
const grupo4 = new Cl_Grupo("D", 3, 9);
const grupo5 = new Cl_Grupo("E", 1, 5);
